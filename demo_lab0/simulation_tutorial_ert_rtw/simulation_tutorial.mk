...
PRODUCT_NAME              = simulation_tutorial
MAKEFILE                  = simulation_tutorial.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/uchen/Documents/4950/demo_lab0
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/uchen/DOCUME~1/MATLAB/R2021a/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/simulation_tutorial.elf
...
%.o : $(START_DIR)/simulation_tutorial_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/simulation_tutorial_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/simulation_tutorial_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
simulation_tutorial.o : $(START_DIR)/simulation_tutorial_ert_rtw/simulation_tutorial.c
	$(CC) $(CFLAGS) -o "$@" "$<"
