###########################################################################
## Makefile generated for component 'motor_model_updated_F21'. 
## 
## Makefile     : motor_model_updated_F21.mk
## Generated on : Wed Nov 02 11:34:04 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/motor_model_updated_F21.elf
...
PRODUCT_NAME              = motor_model_updated_F21
MAKEFILE                  = motor_model_updated_F21.mk
...
SLIB_PATH        = C:/Users/uchen/DOCUME~1/MATLAB/R2021a/ARDUIN~1/ARDUIN~1/FASTER~2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/motor_model_updated_F21.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=5 -DMW_PRESCALAR=64 -DMW_TIMERCOUNT=65286 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=motor_model_updated_F21 -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinobase/src/MW_arduino_digitalio.cpp C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinobase/src/MW_PWM.cpp C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinobase/src/MW_PWMDriver.c C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinobase/src/ArduinoPinHandleMap.cpp $(START_DIR)/motor_model_updated_F21_ert_rtw/motor_model_updated_F21.c $(START_DIR)/motor_model_updated_F21_ert_rtw/motor_model_updated_F21_data.c $(START_DIR)/motor_model_updated_F21_ert_rtw/rtGetInf.c $(START_DIR)/motor_model_updated_F21_ert_rtw/rtGetNaN.c $(START_DIR)/motor_model_updated_F21_ert_rtw/rt_nonfinite.c C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp

MAIN_SRC = $(START_DIR)/motor_model_updated_F21_ert_rtw/ert_main.c
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o motor_model_updated_F21.o motor_model_updated_F21_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/motor_model_updated_F21_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/motor_model_updated_F21_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/motor_model_updated_F21_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/motor_model_updated_F21_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motor_model_updated_F21.o : $(START_DIR)/motor_model_updated_F21_ert_rtw/motor_model_updated_F21.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motor_model_updated_F21_data.o : $(START_DIR)/motor_model_updated_F21_ert_rtw/motor_model_updated_F21_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/motor_model_updated_F21_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/motor_model_updated_F21_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/motor_model_updated_F21_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
